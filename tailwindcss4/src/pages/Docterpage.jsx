            ...
            <div className="flex justify-center items-center">
                {showData && (
                    <div className="mt-6 text-center w-full max-w-5xl p-6 rounded-lg overflow-auto shadow-lg">
                        <button onClick={fetchData} className="bg-purple-500 text-white py-2 px-6 rounded-lg cursor-pointer">
                            Get Data
                        </button>
                        <button  className="bg-purple-500 text-white py-2 px-6 rounded-lg ml-6">
                            Upload data
                        </button>
                                ...
                                {filteredFiles.map((file, index) => (
                                    <div key={index} className="bg-white/10 flex justify-between items-center backdrop-blur-md scale-95 hover:scale-100 transition-transform duration-300 p-6 rounded-lg shadow-lg text-white">
                                        ...
                                        <div className="flex gap-4">
                                            <button onClick={() => alert(`Previewing ${file.name}`)} className="text-green-500 text-2xl hover:text-primary">
